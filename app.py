...
SHEET_CSV_URL = st.sidebar.text_input(
    "📊 구글 시트 CSV 링크 연결", 
    https://docs.google.com/spreadsheets/d/e/2PACX-1vTXDGTnMc8RO3wBVza0w10tR4GuYY_wUUXtfRKae2wYPJWWfCqHK5gRwJqHlEmiY66tR5gr70NJBbEJ/pub?gid=0&single=true&output=csv" #여기에 복사한 주소를 넣으세요
)
